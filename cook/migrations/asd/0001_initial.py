# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2018-11-25 13:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order', to='cook.CookOrder')),
            ],
        ),
        migrations.CreateModel(
            name='Currency',
        ...
        migrations.AddField(
            model_name='cookorder',
            name='task',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='task', to='cook.CookTask'),
        ),
    ]
