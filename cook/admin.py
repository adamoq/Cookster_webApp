...
from .models import Dish, Product, Employee, WaiterTask, CookTask, Category, DishPrice, Currency, RestaurantDetail,LoginLog,WaiterOrder, CookOrder, CookTaskOrder
...
admin.site.register(CookTaskOrder)
