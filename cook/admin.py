...
from .models import Dish, Product, Employee, WaiterTask, CookTask, Category, DishPrice, Currency, RestaurantDetail,LoginLog,WaiterOrder, CookOrder, CookOrderTask
...
admin.site.register(CookOrderTask)
