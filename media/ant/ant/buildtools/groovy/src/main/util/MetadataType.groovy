...
public class MetadataType {
    ...
    private _describeFolders(ConnectionInfo connectionInfo,
        ...
        if ( !CommandRunner.ERROR.equals(output)) {
        ...
        if ( describeFile.exists()){
            ...
            describeFile.eachLine { String line ->
                if ( line.equals(SECTIONDELIMITER)) {
                    ...
                    if ( line.startsWith(FullNameIdPrefix)) {
                    ...
                    if ( line.startsWith(ManageableStatePrefix)) {
                    ...
                    if ( line.startsWith(NamespacePrefixPrefix)) {
